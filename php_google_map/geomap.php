...
function geocode($address){
    ...
    $url = "https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyA5VMrUq1nrnRI6jTArkEJIO35el0YLwMA&callback=initMap";
...
if($_POST){
    ...
    <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyA5VMrUq1nrnRI6jTArkEJIO35el0YLwMA&callback=initMap"></script>  
